                ...
                <div class="p-4 shadow sm:rounded-lg sm:p-8">
                    <form id="permissionsForm" >
                        ...
                        <div class="mt-4 flex justify-end space-x-2">
                            ...
                            <button type="submit" @click.prevent="submitHandler" class="bg-blue-500 text-white px-4 py-2 rounded">
                                Update Permission
                            </button>
                        </div>
                    </form>
...
const getAssignLeadFields = () => {
    let endPoint = `${import.meta.env.VITE_API_BASE_URL}get/assign/fields/${getUserRoleId.value}`;
    HTTP
        .get(endPoint)
        .then((response) => {
