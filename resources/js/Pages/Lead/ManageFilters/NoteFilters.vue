...
const filterType = ref('noteFilter');
...
const createTable = (page) => {
    ...
    let endpoint = `${import.meta.env.VITE_API_BASE_URL}note/strike/first`;
    axios
        .get(endpoint, {
...
const deleteFilter = (type = "", filterId = "") => {
    ...
    let endPoint = `${import.meta.env.VITE_API_BASE_URL}note/strike/first/${destroyFilterId.value}`;
