...
const createTable = (page) => {
    ...
    let endpoint = `${import.meta.env.VITE_API_BASE_URL}lead/tags`;
    axios
        .get(endpoint, {
...
const deleteFilter = (type = "", filterId = "") => {
    ...
    let endPoint = `${import.meta.env.VITE_API_BASE_URL}lead/tags/${destroyFilterId.value}`;
...
const updateFilter = (index) => {
    ...
    let endpoint = `${import.meta.env.VITE_API_BASE_URL}lead/tags/${filterId.value}`;
    axios
        .put(endpoint, {
