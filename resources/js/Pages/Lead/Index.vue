        ...
        <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-lg dark:border-gray-700 dark:bg-gray-800">
            ...
            <div class="space-y-4">
                ...
                <div class="flex flex-wrap items-center justify-between">
                    ...
                    <!-- Alternative Button -->
                    <Link :href="route('lead.import.page')"
                ...
                <table
                    ...
                    <thead class="bg-blue-500">
                        <tr>
                            ...
                            <th class="px-4 py-2 text-left text-sm font-semibold text-white">City</th>
                            <th class="px-4 py-2 text-left text-sm font-semibold text-white">State</th>
                    ...
                    <tbody>
                        <tr v-for="(user, index) in leads" :key="user"
