                        ...
                        <tr class="whitespace-nowrap" v-for="(color, index) in colors" :key="color">
                            ...
                            <td class="py-5 px-4">
                                <div class="flex items-center space-x-3.5">
                                    ...
                                    <Link :href="route('lead_color.delete', { id: color.id })"
            ...
            <DefaultCard cardTitle="Lead color">
                <div class="p-4 shadow sm:rounded-lg sm:p-8">
                    <div class="mb-4">
                        ...
                        <SelectInput id="column_key" class="mt-1 block w-full" v-model="form.column_key" required
                            autofocus :disabled="row ? true : false">
...
const submitForm = () => {
    let method = "post";
    let actionUrl = "leadcolors.store";
    if (form.value.id) {
        method = "put";
        actionUrl = "leadcolors.update";
    }
